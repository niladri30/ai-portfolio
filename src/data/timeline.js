export const timeline = [
  {
    ...
    highlights: [
      ...
      "Designed AI-powered business process automation solutions",
      "Drove SAP BTP AI Core and Generative AI Hub adoption",
      "Established best practices for RAG, vector search, and agentic AI"
    ],
    achievements: [
      "Delivered AI solutions reducing operational time by up to 75%",
      "Enabled non-technical users to leverage AI through conversational interfaces",
      "Integrated AI with SAP S/4HANA across inventory, procurement, and finance domains",
      "Built reusable AI frameworks and accelerators for rapid deployment"
    ],
    technologies: ["SAP AI Core", "Generative AI Hub", "LangChain", "Python", "SAP BTP", "HANA Cloud"],
    type: "current"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    highlights: [
      "Designed enterprise solutions on SAP BTP",
      "Led integration architecture for S/4HANA Cloud",
      "Implemented workflow automation using SAP Build",
      "Mentored development teams on cloud-native practices",
      "Contributed to early AI/ML exploration initiatives"
    ],
    achievements: [
      "Successfully delivered multiple SAP BTP transformation projects",
      "Established integration patterns for hybrid landscapes",
      "Reduced development time through reusable components"
    ],
    technologies: ["SAP BTP", "Cloud Foundry", "HANA Cloud", "Integration Suite", "SAP Build"],
    type: "past"
  },
  {
    id: 4,
  ...
  },
  {
    ...
    location: "India",
    description: "Software development and technical leadership for banking and financial services clients. Progressed from developer to technical lead roles.",
    highlights: [
      "Developed enterprise applications for banking clients",
      "Led technical teams and code reviews",
      "Contributed to architecture and design decisions",
      "Implemented CI/CD practices"
    ],
    achievements: [
      "Delivered high-quality solutions for critical banking processes",
      "Established development best practices",
      "Grew from individual contributor to technical leadership"
    ],
    technologies: ["Java", "J2EE", "SQL", "Web Services", "Banking Systems"],
    type: "past"
  }
];
